...
export function createRun(seed,hero='kaerun',options={}){
 ...
 const enemyRoster=options.enemyRoster??2,beastSystem=options.beastSystem??3;const firstThree=enemyRoster===2?shuffle(INVADERS,state).slice(0,3):null;
